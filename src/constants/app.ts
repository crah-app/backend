...
export class App {
	...
	async get(path: string, fn: (req: Request, res: Response) => Promise<Err | void>) {
	...
	async post(path: string, fn: (req: Request, res: Response) => Promise<Err | void>) {
	...
	async delete(path: string, fn: (req: Request, res: Response) => Promise<Err | void>) {
