...
INSERT IGNORE INTO Emojies (Id) VALUES 
('1F44D'),
('2764'),
('1F602'),
('1F62E'),
...
CREATE TABLE Reactions (
    ...
    UNIQUE KEY unique_post_user_emoji (PostId, UserId, EmojiId)
);
...
CREATE TABLE Participants (
    ...
    CONSTRAINT fk_participant__post FOREIGN KEY (PostId) REFERENCES Posts(Id) ON DELETE CASCADE ON UPDATE RESTRICT,
    CONSTRAINT fk_participant__user FOREIGN KEY (UserId) REFERENCES Users(Id) ON DELETE CASCADE ON UPDATE RESTRICT
);
